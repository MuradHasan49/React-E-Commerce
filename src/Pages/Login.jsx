      ...
      <div className="flex flex-col md:flex md:flex-row items-center gap-35 py-15">
        ...
        <div className="">
          ...
          <div className="flex flex-col gap-5">
            <h1 className="font-medium text-4xl leading-7.5 tracking-[4%]">Log in to Exclusive</h1>
          ...
          <div className="flex flex-row justify-between">
            <button className=" px-12 py-4 text-white bg-[#DB4444] rounded-md cursor-pointer ">Log in</button>
            <div className="flex items-center gap-2  rounded-md  px-4 py-3 justify-center cursor-pointer">
              <button className="hover:underline hover:underline-offset-5 cursor-pointer"> Forget Password?</button>
            </div>
          </div>
        </div>
      </div>
