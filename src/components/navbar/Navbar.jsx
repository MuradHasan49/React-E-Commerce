          ...
          <div className="flex gap-12 text-base font-semibold">
            {["Home", "Contact", "About", "Sign Up"].map((item) => (
              <div key={item} className="relative group cursor-pointer">
                <a
                  href="#"
                  className="text-gray-500 font-medium text-[17px] py-2 flex items-center transition-all duration-300 group-hover:text-[#000000]"
                >
                  {item}
                </a>
                <span className="absolute bottom-0 left-0 w-0 h-[3px] bg-[#000000] rounded-full transition-all duration-300 group-hover:w-full"></span>
              </div>
            ))}
          </div>
